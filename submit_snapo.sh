...
/scratch-second/nipopovic/apps/miniconda3/envs/qdtrack/bin/python tools/inference.py --config ${CONFIG_FILE} --input ${INPUT_FILE_OR_FOLDER} --output ${OUTPUT_FILE_OR_FOLDER} --checkpoint ${CHECKPOINT_FILE} --fps ${FPS}